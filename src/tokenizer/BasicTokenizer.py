...
class BasicTokenizer(Tokenizer):
    ...
    def train(self, text, vocab_size,  verbose=False):
        ...
        # to count only new pairs eliminated/created by the previous added id
        # a b c d
        # if bc were pair to merge and replaced with e, then ab and cd counts have to be subtracted of every occurrence, and ae ed pairs have to be added
